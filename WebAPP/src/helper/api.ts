...
class api {
    static request = async function (reqType:requestTypeEnum , url: string, auth: boolean, body: any = null, requestType = dataFormEnum.json, responseType: dataFormEnum = dataFormEnum.json): Promise<any> {
...
export class useApi {
    ...
    sendSignUp = async (data: SignUpEmail) => {
        ...
        return await new Promise<Boolean>((resolve, reject) => {
            ...
            api.request(requestTypeEnum.post,url,false, dataBody,dataFormEnum.json).then((response) => {
                resolve(true)
            }).catch((e) => {
                reject(e)
            })
