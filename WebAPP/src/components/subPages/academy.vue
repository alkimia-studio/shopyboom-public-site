...
<template>
  <Stack
    :class="size.biggerThan(sizeType.md) ? 'pr35 pl35 pt50 pb50' : 'pr5 pl5'"
    direction="column"
      ...
      <Grid :lg="1" :md="1">
        <Stack direction="column" justifyContent="flex-start" alignItems="flex-start">
          <Appsvg
            ...
            :class="size.biggerThan(sizeType.lg) ? 'mb8' : 'mt10 mb4'"
            :xsw="60"
            :lgw="80"
          >
            <IStudyHat />
          ...
          <Txt
            bold
            :line-height="size.biggerThan(sizeType.md) ? 150 : 70"
            :font="2"
            :color="3"
            :xs="62"
            :lg="110"
