...
<template>
    ...
    <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35 pt20' : 'pr5 pl5 pt20 '" direction="column"
        ...
        <Grid class="height-100p width-100p" container :gap="20" :lg="3" :xs="1">
            <Grid :lg="1" :xs="1">
                <Anim delay="600" when="pageload" in="animate__fadeInUp opacity-1" out="" count="1" class="opacity-0">
            ...
            <Grid :lg="1" :xs="1">
                <Anim :delay="size.biggerThan(sizeType.lg) ? 800 : 0" :when="size.biggerThan(sizeType.lg) ? 'pageload' : 'scroll'" in="animate__fadeInUp opacity-1" out="" count="1" class="opacity-0" scroll-lg="404" scroll-md="341" scroll-sm="405" scroll-xs="490">
                    <Stack class="height-100p" direction="column" justifyContent="flex-start" alignItems="flex-start">
                        <Stack class="pb8 width-100p" direction="column" justifyContent="space-between" alignItems="flex-start">
                            <Stack class="width-100p" direction="column" justifyContent="flex-start"
                                alignItems="flex-start">
            ...
            <Grid :lg="1" :xs="1">
                <Anim :delay="size.biggerThan(sizeType.lg) ? 1000 : 0" :when="size.biggerThan(sizeType.lg) ? 'pageload' : 'scroll'" in="animate__fadeInUp opacity-1" out="" count="1" class="opacity-0" scroll-lg="884" scroll-md="804" scroll-sm="878" scroll-xs="953">
                <Stack class="height-100p" direction="column" justifyContent="flex-start" alignItems="flex-start">
                    <Stack class="pb8 width-100p" direction="column" justifyContent="space-between" alignItems="flex-start">
                        <Stack class="width-100p" direction="column" justifyContent="flex-start"
                            alignItems="flex-start">
            ...
            <Grid :lg="1" :xs="1">
                <Stack class="height-100p" direction="column" justifyContent="center" alignItems="center">
                    <Txt :font=1 :color=1 :md=20 :xs=16>
                        {{ data.risorse.part3.right.body1 }}
                    </Txt>
                </Stack>
            </Grid>
        </Grid>
