...
<template>
  <Banner1 src="/images/image1.jpg" class="backgroundapp-color-11" :opacity="0.35">
    ...
    data.home.part1.title5}}</Txt>
    </Anim>
    <Anim delay="1200" when="pageload" class="opacity-0" in="animate__fadeIn opacity-1" out="" count="1">
        ...
        <Grid :xl="1" :lg="1">
          <Stack direction="column" justifyContent="flex-start" alignItems="flex-start">
            ...
            <Stack class="mt8 hr1 width-100p" direction="column" justifyContent="flex-start" alignItems="flex-start">
              <Stack class="width-100p" v-for="(item, index) in data.home.part2.right.links" :key="index"
    ...
    <Anim auto-scroll-offset="50" when="scroll" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0 width-100p">
      <Stack :direction="size.biggerThan(sizeType.sm) ? 'row' : 'column'" class="width-100p pt30 pb30"
        ...
        <Txt class="pr2 word-no-break" :text-align="size.biggerThan(sizeType.sm) ? 'right' : 'center'" :font="1"
          :color="1" :lg="48" :md="30" :sm="30" :xs="24">{{ data.home.part3.title1 }}</Txt>
        <Txt :class="size.biggerThan(sizeType.sm) ? '' : 'mt6'" class="pl2"
          :text-align="size.biggerThan(sizeType.sm) ? 'left' : 'center'" :font="1" :color="1" :lg="48" :md="30" :sm="30"
          :xs="24" bold>{{ data.header.sitename }}</Txt>
      </Stack>
    </Anim>
  </Stack>
  <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35' : 'pr5 pl5'" direction="column" justifyContent="flex-start"
