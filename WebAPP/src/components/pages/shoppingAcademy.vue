...
<template>
  <Stack class="backgroundapp-color-1 pt40 pb40 pr10 p10 width-100p" direction="column" justifyContent="center"
    alignItems="center">
    ...
    <Txt tag="h1" text-align="center" :font="2" :color="3" :lg="100" :xs="56">{{
      data.shoppingAcademy.part1.title1
    }}</Txt>
    </Anim>
    ...
    <Txt tag="h2" text-align="center" :font="1" :color="2" :lg="34" :xs="24">{{
      data.shoppingAcademy.part1.title2
    }}</Txt>
    </Anim>
  </Stack>
  <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35 pt20' : 'pr5 pl5 pt20'" direction="column"
    ...
    <Anim when="pageload" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0">
    <Grid class="width-100p" :class="size.biggerThan(sizeType.lg) ? 'mt40' : ''" container :lg="2" :xs="1">
      <Grid :lg="1" :xs="1">
        <Stack direction="column" justifyContent="flex-start" alignItems="flex-start">
          <Txt tag="h3" bold :font="1" :color="1" :xs="35" :lg="60">
            {{ data.shoppingAcademy.part2.left.title1 }}
          </Txt>
        </Stack>
      </Grid>
      <Grid :lg="1" :xs="1">
        <Stack class="height-100p" direction="column" justifyContent="center" alignItems="center">
          <Txt :font="1" :color="1" :md="20" :xs="16">
            {{ data.shoppingAcademy.part2.right.body1 }}
          </Txt>
        </Stack>
      </Grid>
    </Grid>
  ...
  <swiper-container v-if="!size.biggerThan(sizeType.md)" :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35' : 'pr5 pl5'"
    class="mt10 backgroundapp-color-2" :slides-per-view="size.biggerThan(sizeType.xs) ? 2 : 1" speed="500"
    space-between="16">
  ...
  <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35' : 'pr5 pl5 '" direction="column" justifyContent="flex-start"
    ...
    <Anim auto-scroll-offset="100" when="scroll" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0">
      <Grid class="mt40 width-100p" container :lg="2" :xs="1">
        <Grid :lg="1" :xs="1">
          <Stack direction="column" justifyContent="flex-start" alignItems="flex-start">
            <Txt  tag="h3" bold :font="1" :color="1" :xs="35" :lg="60">
              {{ data.shoppingAcademy.part3.left.title1 }}
            </Txt>
          </Stack>
        </Grid>
        <Grid :lg="1" :xs="1">
          <Stack class="height-100p" direction="column" justifyContent="center" alignItems="center">
            <Txt :font="1" :color="1" :md="20" :xs="16">
              {{ data.shoppingAcademy.part3.right.body1 }}
            </Txt>
          </Stack>
        </Grid>
      </Grid>
    ...
    <Anim auto-scroll-offset="100" when="scroll" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0">
      <Grid class="mt40 width-100p" container :lg="2" :xs="1">
        <Grid :lg="1" :xs="1">
          <Stack direction="column" justifyContent="flex-start" alignItems="flex-start">
            <Txt  tag="h3" bold :font="1" :color="1" :xs="35" :lg="60">
              {{ data.shoppingAcademy.part4.left.title1 }}
            </Txt>
          </Stack>
        </Grid>
        <Grid :lg="1" :xs="1">
          <Stack class="height-100p" direction="column" justifyContent="center" alignItems="center">
            <Txt :font="1" :color="1" :md="20" :xs="16">
              {{ data.shoppingAcademy.part4.right.body1 }}
            </Txt>
          </Stack>
        </Grid>
      </Grid>
  ...
  <Anim auto-scroll-offset="150" when="scroll" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0">
  <OpenShop bellStars />
  </Anim>
  <Anim auto-scroll-offset="150" when="scroll" in="animate__fadeInUp  opacity-1" out="" count="1" class="opacity-0">
  <Opportunity />
