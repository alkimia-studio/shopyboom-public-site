...
<template>
    <Stack class="backgroundapp-color-1 pt40 pb40 pr10 p10 width-100p" direction="column" justifyContent="center"
        alignItems="center">
        <Txt text-align="center" :font=2 :color=3 :lg="100" :xs="56">{{ data.shoppingAcademy.part1.title1 }}</Txt>
        <Txt text-align="center" :font=1 :color=2 :lg="34" :xs="24">{{ data.shoppingAcademy.part1.title2 }}</Txt>
    </Stack>
    <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35 pt20 pb20' : 'pr5 pl5 pt20 pb20'" direction="column"
        ...
        <Carousel class="mt10" v-else :items-to-show="size.biggerThan(sizeType.xs) ? 2 : 1">
            <Slide v-for="(item, index) in data.shoppingAcademy.part2.items" :key="index">
                <div class="pr3 pl3">
                    <div class="position-relative">
                        <div class="backgroundapp-color-1 image2-border-radius">
                            <div class="image2 image-fitparent-width image2-border-radius"
        ...
        <Carousel class="mt10" v-else :items-to-show="size.biggerThan(sizeType.xs) ? 2 : 1">
            <Slide v-for="(item, index) in data.shoppingAcademy.part3.items" :key="index">
                <div class="pr3 pl3">
                    <div class="position-relative">
                        <div class="backgroundapp-color-1 image2-border-radius">
                            <div class="image2 image-fitparent-width image2-border-radius"
        ...
        <Carousel class="mt10" v-else :items-to-show="size.biggerThan(sizeType.xs) ? 2 : 1">
            <Slide v-for="(item, index) in data.shoppingAcademy.part4.items" :key="index">
                <div class="pr3 pl3">
                    <div class="position-relative">
                        <div class="backgroundapp-color-1 image2-border-radius">
                            <div class="image2 image-fitparent-width image2-border-radius"
