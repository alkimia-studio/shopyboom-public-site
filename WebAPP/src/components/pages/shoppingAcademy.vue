...
<template>
  <Stack
    class="backgroundapp-color-1 pt40 pb40 pr10 p10 width-100p"
    direction="column"
  ...
  >
    <Grid
      class="width-100p"
      :class="size.biggerThan(sizeType.lg) ? 'mt40' : ''"
      container
      :lg="2"
      :xs="1"
    >
  ...
  >
    <swiper-slide
      ...
      v-for="(item, index) in data.shoppingAcademy.part2.items"
      :key="index"
    >
      <div>
        <div class="position-relative">
  ...
  >
    <swiper-slide
      class="height-inherit"
      v-for="(item, index) in data.shoppingAcademy.part3.items"
      :key="index"
    >
      <div>
        <div class="position-relative">
  ...
  >
    <swiper-slide
      class="height-inherit"
      v-for="(item, index) in data.shoppingAcademy.part4.items"
      :key="index"
    >
      <div>
        <div class="position-relative">
