...
<template>
      ...
      <Txt :class="size.biggerThan(sizeType.md)
          ...
          : size.biggerThan(sizeType.sm)
            ...
            : size.biggerThan(sizeType.xs)
              ? 'pt35'
              : 'pt25'
        " :font="2" :color="3" :xl="134" :lg="110" :md="80" :sm="70" :xs="45" text-align="center" bold>{{
  ...
  <Stack direction="row" class="width-100p p10" justifyContent="center" alignItems="center">
    <Anim auto-scroll-offset="50"
    :when="size.biggerThan(sizeType.sm) ? 'scroll': 'pageload'" 
    in="animate__fadeInUp opacity-1" out="" count="1" class="opacity-0">
  ...
  <Stack :class="size.biggerThan(sizeType.sm) ? 'pr35 pl35' : 'pr5 pl5 pt20'" direction="column"
    ...
    <Grid :gap="0" :class="size.biggerThan(sizeType.sm) ? '' : 'mb25'" class="mt60 width-100p" container :lg="8"
      :md="1">
      <Grid :lg="5" :md="1">
        <ShapeContainer :xlh="shapeContainerMinHeight.xlh" :lgh="shapeContainerMinHeight.lgh" :mdh="350" :smh="350"
          :xsh="150">
    ...
    <Grid :gap="0" :class="size.biggerThan(sizeType.lg) ? 'pt40' : ''" class="mt60 width-100p" direction="rtl" container
      :lg="8" :md="1">
      <Grid class="direction-ltr" :lg="5" :md="1">
        <ShapeContainer :xlh="shapeContainerMinHeight.xlh" :lgh="shapeContainerMinHeight.lgh"
          :mdh="shapeContainerMinHeight.mdh" :smh="shapeContainerMinHeight.smh" :xsh="shapeContainerMinHeight.xsh">
